...
while operation != "break":
    ...
    a = int(input())
    while operation != "+" and operation != "-" and operation != "*" and operation != "/" and operation != "**" and operation != ">" and operation != "sin":
        print("Введите нужную операцию ",end = '')
        operation = input()
        if operation != "+" and operation != "-" and operation != "*" and operation != "/" and operation != "**" and operation != ">" and operation != "sin":
            print("ошибка ввода")    
